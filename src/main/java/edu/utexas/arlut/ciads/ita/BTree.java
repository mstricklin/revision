...
package edu.utexas.arlut.ciads.ita;
...
public class BTree {
    ...
    private class Node
    {
         ...
         */
        public BTreeHandle BTreeInsertNonfull(Comparable k)
        {
            int i = n-1;
            Comparable kKey = k;
        ...
        private void deleteFromInternalNode(int i)
        {
            ...
            if (y.n >= t) {	          // does y have at least t keys?
                ...
                Comparable kPrime = y.findGreatestInSubtree();
                ...
                Node z = c[i+1];
                if (z.n >= t) {
                    Comparable kPrime = z.findSmallestInSubtree();
         ...
         */
        private Comparable findGreatestInSubtree()
        {
            if (leaf)
                return key[n-1];
            else {
         ...
         * the subtree rooted at this node.
         */
        private Comparable findSmallestInSubtree()
        {
            if (leaf)
                return key[0];
            else {
     ...
     */
    public Object put(Comparable o, Object v) {
        return insert(o);
    }
